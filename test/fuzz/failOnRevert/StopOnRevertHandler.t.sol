...
contract StopOnRevertHandler is Test {
    ...
    // Deployed contracts for interactions
    ...
    // Ghost Variable --> Max deposit size
    ...
    function mintAndDepositCollateral(uint256 collateralSeed, uint256 amountCollateral) public {
        // This needs to be more than 0 and less than the max deposit size
    ...
    function burnDsc(uint256 amountDsc) public {
        // This must be more than 0 and less than the balance of the user
    ...
    /// Helper Functions for DSCEngine
