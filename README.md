...
Welcome to the Foundry DeFi Stablecoin project! This repository is part of the Foundry Cyfrin Updraft Advanced Course for Lesson 12: Foundry DeFi StableCoin. This project aims to create a stablecoin where users can deposit WETH and WBTC in exchange for a token that will be pegged to the USD. 

The comments and insights included in this repository have been invaluable in helping me conceptualize and better understand the project.

# Getting Started 
[Imported From](https://github.com/Cyfrin/foundry-defi-stablecoin-cu/tree/main)
...
## Quickstart from Modified Repository

```
git clone https://github.com/shanemonastero/foundry-defi-stablecoin-cu.git
cd foundry-defi-stablecoin-cu
forge build
